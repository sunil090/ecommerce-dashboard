...
export default function LoginPage() {
  ...
  function handleGoogleLogin() {
    // Redirect to your server-side Google OAuth entrypoint
    // Implement /api/auth/google (example NextAuth or a custom route)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-md p-6">
        ...
        <p className="text-sm text-gray-500 mb-6">Enter your admin credentials</p>
        ...
        <div className="space-y-4">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <p className="text-center text-sm text-gray-600">
              Don't have an account? <a className="text-blue-600 underline" href="/signup">Create one</a>
            </p>
          </form>
        </div>
      </div>
